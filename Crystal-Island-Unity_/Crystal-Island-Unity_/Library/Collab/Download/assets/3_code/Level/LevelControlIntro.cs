...
namespace Polymoney
{
    ...
    public class LevelControlIntro : VCBehaviour<Level>
    {
        ...
        private IEnumerator introRoutine()
        {
            ...
            Alert.info("tutoIntroQuest", new Alert.AlertParams { useLocalization = true, title = "tutoMStoryIslandTitle", closeText = "btnOk" });
            while (Alert.open)
                yield return null;
            Alert.info("tutoLetsPlay", new Alert.AlertParams { useLocalization = true, title = "tutoMStoryIslandTitle", closeText = "btnOk" });
            while (Alert.open)
                yield return null;
